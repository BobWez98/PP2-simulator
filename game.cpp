...
#define REF_PERFORMANCE 65914.3 //UPDATE THIS WITH YOUR REFERENCE PERFORMANCE (see console after 2k frames)
...
void Game::draw()
{
    ...
    int explosionmod = explosions.size() % threadCount;
    std::vector<future<void>*> explosionFutures;
    for (int i = 0; i < threadCount; i++)
    {
        int start = explosionCurrent;
